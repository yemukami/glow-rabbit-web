...
- 今日の進捗: start/stop/sync/モーダルのレース参照を race-manager の getRaceById/getActiveRace 経由に寄せてガードを強化し、startPos 更新を非負サニタイズに変更（挙動は既存仕様のまま）。
